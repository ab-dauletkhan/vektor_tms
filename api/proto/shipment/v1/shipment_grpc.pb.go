...
const (
	...
	ShipmentService_AddShipmentStatusEvent_FullMethodName = "/shipment.v1.ShipmentService/AddShipmentStatusEvent"
...
type ShipmentServiceClient interface {
	...
	AddShipmentStatusEvent(ctx context.Context, in *AddShipmentStatusEventRequest, opts ...grpc.CallOption) (*AddShipmentStatusEventResponse, error)
...
func (c *shipmentServiceClient) AddShipmentStatusEvent(ctx context.Context, in *AddShipmentStatusEventRequest, opts ...grpc.CallOption) (*AddShipmentStatusEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddShipmentStatusEventResponse)
	err := c.cc.Invoke(ctx, ShipmentService_AddShipmentStatusEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShipmentServiceServer interface {
	...
	AddShipmentStatusEvent(context.Context, *AddShipmentStatusEventRequest) (*AddShipmentStatusEventResponse, error)
...
func (UnimplementedShipmentServiceServer) AddShipmentStatusEvent(context.Context, *AddShipmentStatusEventRequest) (*AddShipmentStatusEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddShipmentStatusEvent not implemented")
}
...
func _ShipmentService_AddShipmentStatusEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddShipmentStatusEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShipmentServiceServer).AddShipmentStatusEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShipmentService_AddShipmentStatusEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShipmentServiceServer).AddShipmentStatusEvent(ctx, req.(*AddShipmentStatusEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShipmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddShipmentStatusEvent",
			Handler:    _ShipmentService_AddShipmentStatusEvent_Handler,
		},
		{
